...
def localize(world, measurements, motions, sensor_right, p_move):
    '''
    Given a grid world, a series of measurements and motions, and probabilities
    that the sensor meausrements are correct, and that motions are successful,
    return the posterior probability of belief of location (assuming a uniform
    prior).  Assume ordering is move then sense, repeat.
    '''
...
print 'localize:'
posterior = localize(colors, measurements, motions, sensor_right, p_move)
print posterior
